        ...
        <Col>
          <Card style={{marginTop:"2rem"}}>
            ...
            <Card.Body>
              ...
              <Link to={props.link}><center><Button variant="primary" className={style.primary} style={{padding:"0.6rem", width:"8rem", fontSize:"1.2rem"}}>{props.button}</Button></center></Link>
            </Card.Body>
          </Card>
        </Col>
      ))}
